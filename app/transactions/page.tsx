...
export default class Transactions extends React.Component<{ children: React.ReactNode }> {
                        ...
                        <div className={"w-1/6 flex flex-col rounded-2xl bg-black"}>
                            ...
                            <div className={"mx-7 flex flex-col h-full justify-between top-10"}>
                                ...
                                <div className={"my-4 flex flex-col"}>
                                    ...
                                    <a href={"mailto:mukulphoughat@gmail.com"} className={"text-sm text-white " + montserrat.className}>Contact Us</a>
                                </div>
                            </div>
                        </div>
